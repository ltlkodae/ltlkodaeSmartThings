...
metadata {
	definition(name: "SmartSense Temp/Humidity Sensor ltlkodae", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, ocfDeviceType: "oic.d.thermostat") {
